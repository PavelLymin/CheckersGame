...
{
    public partial class FormGameSetings : Form
    {
        ...
        public FormGameSetings(int BoardSize)
        {
            InitializeComponent();

            mapSize = BoardSize;
            whiteFigure = new Bitmap(new Bitmap("WhiteFigure.png"), new Size(cellSize - 10, cellSize - 10));
            blackFigure = new Bitmap(new Bitmap("BlackFigure.png"), new Size(cellSize - 10, cellSize - 10));
            whiteDamka = new Bitmap(new Bitmap("WhiteDamka.png"), new Size(cellSize - 10, cellSize - 10));
            blackDamka = new Bitmap(new Bitmap("BlackDamka.png"), new Size(cellSize - 10, cellSize - 10));
        ...
        public void Init()
        {
            ...
            for (int i = 0; i < mapSize; i++)
            {
                ...
                {
                    if (i < mapSize / 2 - 1 && (i + j) % 2 != 0 && i < 3)
                        map[i, j] = 1;
                    else if (i > mapSize / 2 && (i + j) % 2 != 0 && i > mapSize - 4)
                        map[i, j] = 2;
                    else
                        map[i, j] = 0;
                }
